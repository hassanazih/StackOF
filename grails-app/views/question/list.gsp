...
<html lang="en">
	...
	<body>
		<richui:tabView id="questionTabs"> 
			<richui:tabLabels> 
				<richui:tabLabel selected="true" title="newest" /> 
				<richui:tabLabel title="featured" /> 
				<richui:tabLabel title="faq" />  
				<richui:tabLabel title="votes" /> 
				<richui:tabLabel title="active" /> 
