									...
									<g:each in="${questionInstanceList}" status="i" var="questionInstance">
										<div class="question-summary">
											<div class="statscontainer">
												...
												<div class="views " title="${fieldValue(bean: questionInstance, field: "votesNb")} ${message(code: 'views.label', default: 'Views')}"> ${fieldValue(bean: questionInstance, field: "viewsNb")} ${message(code: 'views.label', default: 'Views')} </div>
											</div>
											...
											<div class="started fr">
												<div class="user-info ">
													<div class="user-action-time">
														...
														<span class="relativetime" title="${fieldValue(bean: questionInstance, field: "creationDate")}">${fieldValue(bean: questionInstance, field: "creationDate")}</span>
													</div>
